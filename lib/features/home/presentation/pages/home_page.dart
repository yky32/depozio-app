                  ...
                  listeners: [
                    BlocListener<HomeBloc, HomeState>(
                      listenWhen: (previous, current) {
                        ...
                        return previous is HomeRefreshing &&
                    ...
                    BlocListener<AppCoreBloc, AppCoreState>(
                      listenWhen: (previous, current) {
                        // Listen when start date changes in AppCoreSettingsLoaded state
                        // This ensures HomeBloc recalculates totals when startDay setting changes
                      ...
                      listener: (context, state) async {
                        ...
                        // This triggers recalculation of deposits/expenses based on new startDay
                        if (state is AppCoreSettingsLoaded) {
                          LoggerUtil.d(
                            '📅 Start date changed to ${state.startDate}, refreshing home data',
                          );
                              ...
                              builder: (context) {
                                ...
                                return BlocBuilder<AppCoreBloc, AppCoreState>(
                                  ...
                                  builder: (context, appCoreState) {
                                    ...
                                    if (appCoreState
                                        is! AppCoreSettingsLoaded) {
                                      WidgetsBinding.instance
                                          .addPostFrameCallback((_) {
                                            context.read<AppCoreBloc>().add(
                                              const LoadStartDate(),
                                            );
                                          });
                                    }
                                    ...
                                    if (appCoreState is AppCoreSettingsLoaded) {
                                      ...
                                      AppSettingService.init();
                                      startDate =
                                          AppSettingService.getStartDate();
                                    }
